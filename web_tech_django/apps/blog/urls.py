...
urlpatterns = [
    ...
    path('tours/list/all', views.tours_list_all, name='tours_list_all'),
    ...
    path('tours_list_all', views.tours_list_all, name='tours_list_all'),
...
# ------- Hotel urls -------
    ...
    path('hotel/list/all', views.hotels_list_all, name='hotels_list_all'),
